import { Host, useStore, component$ } from '@builder.io/qwik';
    ...
    () => {
        ...
        return (
            <Host
                ...
                onMousedown$={(event, el) => rippleMousedown(state, event, el)}
...
export const rippleMousedown = (
    ...
    requestAnimationFrame(() => {
        positionRipple(el as HTMLElement, event);
        state.drop = true;
    });
};
